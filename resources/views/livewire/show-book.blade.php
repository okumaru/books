<div class="p-14 flex flex-col gap-5" x-data="{books : [], searchData: {}}" x-init="fetch('http://localhost:8000/api/book?page=1', {
              method: 'POST',
              body: null,
              headers: {
  ...
  <div>
    ...
    <!-- Panel -->
    <div>
      <form @submit.prevent="" class="flex gap-3 mb-0">
        ...
        <button x-on:click="fetch('http://localhost:8000/api/book?page=1', {
                method: 'POST',
              ...
              .then(data => books = data); event.preventDefault();" class="basis-1/12 bg-slate-700 px-5 py-3 text-white rounded-sm">
