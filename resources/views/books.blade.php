...
<body class="antialiased" style="background-color: #f3f3f3;">
  ...
  <div style=" padding: 50px;">
    <div style="padding: 10px;margin-bottom: 30px;" class="rounded-md border-gray-300 dark:bg-gray-800 dark:border-gray-700">
      <form id="search-book" class="flex gap-x-2">
        <input type="text" name="title" class="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="title" />
        ...
        <input type="text" name="cat" class="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="cat" />
        <input type="text" name="keyword" class="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="keyword" />
        <input type="text" name="price" class="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="price" />
        <input type="text" name="publisher" class="border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="publisher" />
      ...
      <div class="relative w-full max-w-md h-full md:h-auto mx-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="py-6 px-6 lg:px-8 text-white">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Data Book</h3>
            <div class="book-title flex gap-2 text-sm text-left text-gray-500 dark:text-gray-400 bg-white border-b dark:bg-gray-700 dark:border-gray-600 py-5">
              <div class="basis-1/3 shrink-0 font-bold">Title</div>
              <div class="grow value"></div>
            </div>
            <div class="book-desc flex gap-2 text-sm text-left text-gray-500 dark:text-gray-400 bg-white border-b dark:bg-gray-700 dark:border-gray-600 py-5">
              <div class="basis-1/3 shrink-0 font-bold">Desc</div>
              <div class="grow value"></div>
            </div>
            <div class="book-keywords flex gap-2 text-sm text-left text-gray-500 dark:text-gray-400 bg-white border-b dark:bg-gray-700 dark:border-gray-600 py-5">
              <div class="basis-1/3 shrink-0 font-bold">Keywords</div>
              <div class="grow value"></div>
            </div>
            <div class="book-price flex gap-2 text-sm text-left text-gray-500 dark:text-gray-400 border-b dark:bg-gray-700 dark:border-gray-600 py-5">
              <div class="basis-1/3 shrink-0 font-bold">Price</div>
              <div class="grow value"></div>
            </div>
            <div class="book-stock flex gap-2 text-sm text-left text-gray-500 dark:text-gray-400 border-b dark:bg-gray-700 dark:border-gray-600 py-5">
              <div class="basis-1/3 shrink-0 font-bold">Stock</div>
              <div class="grow value"></div>
            </div>
            <div class="book-publisher flex gap-2 text-sm text-left text-gray-500 dark:text-gray-400 bg-white border-b dark:bg-gray-700 dark:border-gray-600 py-5">
              <div class="basis-1/3 shrink-0 font-bold">Publisher</div>
              <div class="grow value"></div>
            </div>
          ...
          <div class="py-6 px-6 lg:px-8 text-white">
            ...
            <form id="form-update" class="space-y-6" action="#">
              ...
              <div>
                ...
                <input type="text" name="keywords" id="keywords" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
              </div>
              <div>
              ...
              <div>
                ...
                <input type="number" name="stock" id="stock" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
              </div>
              <div>
